      ...
      <div className="relative z-10 mx-auto flex min-h-[86svh] max-w-[92rem] items-center px-6 py-16 md:min-h-[calc(100dvh-7.75rem)] md:px-12 lg:px-16">
        <div className="grid w-full items-center gap-10 lg:grid-cols-[minmax(0,0.92fr)_minmax(360px,0.56fr)]">
          <div className="max-w-4xl pt-10 md:pt-0">
            <p className="mb-8 inline-flex rounded-full border border-cream/20 bg-cream/10 px-4 py-2 text-xs font-semibold uppercase tracking-[0.22em] text-accent backdrop-blur md:mb-10">
              {content.eyebrow}
            </p>
            <h1 className="font-display flex max-w-4xl flex-col gap-3 text-[3.6rem] font-black uppercase leading-[0.95] tracking-normal [word-spacing:0.5em] drop-shadow-[0_4px_14px_rgba(0,0,0,0.28)] md:gap-4 md:text-8xl lg:text-[8.4rem]">
            ...
            <p className="mt-8 max-w-2xl text-lg leading-8 text-cream/90 md:text-xl md:leading-9">
              {content.body}
            </p>
            <div className="mt-9 flex flex-col gap-3 sm:flex-row">
              ...
              >
                {content.ctaPrimary} <span aria-hidden className="ml-1">→</span>
              </Link>
              <Link
                to="/yaz-okulu"
